deck = {
'TEST001':{
        'name':'The first test event',
        'text':'This is the text of the first test event.',
        'unique':False,
        'options':{
            'opt1':{
                'text':'Option 1','new_cards':['TEST002'],
...
'TEST002':{
        'name':'The second test event',
        'text':'This is the text of the second test event.',
        'unique':False,
        'options':{
            'opt1':{
                'text':'Option 1','new_cards':['SD001','SD002'],
                'cost_type':['settlers_count','babies_count'],'cost_amt':[10,5],
                'rwd_type':['settlers_count','babies_approval'],'rwd_amt':[20,1]
            },
            'opt2':{
